...
import frontierIcon from '/territory_symbol_frontier.png';
import deepwoodIcon from '/territory_symbol_deepwood.png';
import wingIcon from '/territory_symbol_wingblight.png';
import dragonIcon from '/territory_symbol_dragonlaw.png';
import astralIcon from '/territory_symbol_astral.png';
import tannIcon from '/territory_symbol_tann.png';
import mountainIcon from '/territory_symbol_mountain.png';
import thaumIcon from '/territory_symbol_thaum.png';
import duelIcon from '/territory_symbol_duel.png';

//how many copies of the primary label exist?
//typically, you don't need to increase this, as subentities will drive
//the titles of mediumer exclaves. its mostly for frontier/symbological territories.
export const entityLabelCounts = new Map([
    ["Ras Thadra", 1],
    ["Promise of Violence", 1],
    ["Wrack", 1],
    ["Moment-Mender", 1],
    ["Nine-Five-Templehouse", 1],
    ["Zero-Zero-Misery", 1],
    ["Old Salt", 1],
    ["Llanyderas", 1],
    ["Unfinished Citadel", 1],
    ["Bataue Qaue", 1],
    ["Devastated Ragammoç", 1],
    ["Hollow Eye", 1],
    ["Yuracche", 1],
    ["Wellik", 1],
    ["Ruby Isle", 1],
    ...
    ["Monad Glaive", 1],
    ["Havenspool", 1],
    ["Seven-Three-Chatri", 1],
    ["Four-Nine-Vlisc", 1],
    ["HARNESS SEGMENT C-18-18-BQ", 1],
    ["Ras Katra", 1],
    ["Dom Galach", 1],
    ["Dom Kav'ch", 1],
    ["Status Unknown", 1],
    ["Ecological Extrema", 1],
    ["Thaumatological Distortion", 3],
    ["Mountaincarver Tectonics", 2],
    ["Duel Blasts", 5],
    ["Tannsland", 1],
    ["Astral Scorch", 1],
    ["Dragonlaw", 1],
    ...
    ["Unbound Deepwood", 1],
    ["The Frontier", 15],
    ["Fragments of the Era", 2],
    ["Fragments of the Forgotten", 2],
    ["Iconic Exclusions", 2],
    ["Underden (Halls of Rot)", 2],
    ["The Thousand Tombs of the Mound-King", 1],
    ["Ralholm", 1],
    ["Vordain", 1],
    ["Antimortal Empires", 5],
    ["Silences", 1],
    ["Diralia", 1],
    ["Porbagagi", 1],
    ["West Gova", 1],
    ...
    ["Ganai", 1],
    ["Theodryia", 1],
    ["Northmount Calamity Concern", 1],
    ["Lanternholds", 3],
    ["Deadlands Purging Company", 1],
    ["Unincorporated Vampiric Territories", 1],
    ["Irsavit", 1],
    ["Krym", 1],
    ["Isles of Contentment", 1],
    ["Citadel Governatorates", 1],
    ["Old-World Establishments", 1],
    ["The Dream", 1],
    ["Worthwood Sanctuary", 1],
    ["Kalamant", 1],
    ["The Theodryian Bridge", 1],
    ["Rhômi's Hand", 1],
    ["The Stone Unit", 1],
    ["East Gova", 1],
    ["Old Durnham", 1],
    ...
    ["Fritzand", 1],
    ["Lorgge", 1],
    ["Semiautonomous Kingdom of Zanasa", 1],
    ["Mkala'al", 1],
    ["Coros", 1],
    ["Brelg", 1],
    ["Sar-sal-Salír", 1],
    ...
    ["Avaroth?", 1],
    ["Draid", 2],
    ["Clayman Gildsman Lösman", 1],
    ["Sathal", 1],
    ["Anterros", 1],
    ["Thas-Thuay Collaborate", 1],
    ["Yadanai", 1],
    ["Lakyrimati", 1],
    ["Sulphurfort", 1],
    ["Ilkair", 1],
    ["Deilān Federation", 1],
    ["Northern Shab Council", 1],
    ["Central Mint", 1],
    ["Operational No-Zones", 1],
    ["Vladisland", 1],
    ["Jadiz", 1],
    ["Ithûk", 1],
    ["Dreadpoint", 1],
    ...
    ["Isles of Security", 1],
    ["Mes-Mas-Malas", 1],
    ["Brassworks Fellowship", 1],
    ["Moristene", 1],
    ["Northsea Confederacy", 1],
    ["Hei Kophkatos", 1],
    ["Wahlrect", 1],
    ["Vaxassa Xaoxavas", 1],
    ["Ilvor-Ilvindal", 1],
...
export const entityLabelSizes = new Map([
    ["Ras Thadra", "medium"],
    ["Promise of Violence", "medium"],
    ["Wrack", "medium"],
    ["Moment-Mender", "medium"],
    ["Nine-Five-Templehouse", "medium"],
    ["Zero-Zero-Misery", "medium"],
    ["Old Salt", "medium"],
    ["Llanyderas", "medium"],
    ["Unfinished Citadel", "medium"],
    ["Bataue Qaue", "medium"],
    ["Devastated Ragammoç", "medium"],
    ["Hollow Eye", "medium"],
    ["Yuracche", "medium"],
    ["Wellik", "medium"],
    ["Ruby Isle", "medium"],
    ...
    ["Mabel's Rime", "medium"],
    ["Guldura", "medium"],
    ["Western Kallabastian Lobby", "small"],
    ["Three-One-Three", "small"],
    ["Rahwi Rosj", "small"],
    ["Stonesalve", "medium"],
    ["Witchclave", "medium"],
    ["Stratum Mercay", "small"],
    ["Mjahai Osal", "medium"],
    ["Irwin's Pact", "medium"],
    ["Bohras Midor", "medium"],
    ["Naserii", "medium"],
    ...
    ["Monad Glaive", "medium"],
    ["Havenspool", "medium"],
    ["Seven-Three-Chatri", "medium"],
    ["Four-Nine-Vlisc", "medium"],
    ["HARNESS SEGMENT C-18-18-BQ", "small"],
    ["Ras Katra", "medium"],
    ["Dom Galach", "medium"],
    ["Dom Kav'ch", "medium"],
    ["Status Unknown", "medium"],
    ["Ecological Extrema", "medium"],
    ["Thaumatological Distortion", "medium"],
    ["Mountaincarver Tectonics", "medium"],
    ["Duel Blasts", "medium"],
    ["Tannsland", "large"],
    ["Astral Scorch", "medium"],
    ["Dragonlaw", "medium"],
    ["Wingblight Wastes", "medium"],
    ["Zharr", "medium"],
    ["Unbound Deepwood", "medium"],
    ["The Frontier", "medium"],
    ["Fragments of the Era", "medium"],
    ["Fragments of the Forgotten", "medium"],
    ["Iconic Exclusions", "medium"],
    ["Underden (Halls of Rot)", "medium"],
    ["The Thousand Tombs of the Mound-King", "medium"],
    ["Ralholm", "medium"],
    ["Vordain", "medium"],
    ["Antimortal Empires", "small"],
    ["Silences", "large"],
    ["Diralia", "medium"],
    ["Porbagagi", "medium"],
    ["West Gova", "medium"],
    ...
    ["Ganai", "medium"],
    ["Theodryia", "medium"],
    ["Northmount Calamity Concern", "small"],
    ["Lanternholds", "medium"],
    ["Deadlands Purging Company", "medium"],
    ["Unincorporated Vampiric Territories", "medium"],
    ["Irsavit", "medium"],
    ["Krym", "medium"],
    ["Isles of Contentment", "medium"],
    ["Citadel Governatorates", "small"],
    ["Old-World Establishments", "small"],
    ["The Dream", "medium"],
    ["Worthwood Sanctuary", "large"],
    ["Kalamant", "medium"],
    ["The Theodryian Bridge", "medium"],
    ["Rhômi's Hand", "large"],
    ["The Stone Unit", "medium"],
    ["East Gova", "medium"],
    ["Old Durnham", "medium"],
    ["Naalia", "medium"],
    ["Yardol", "medium"],
    ...
    ["Fritzand", "medium"],
    ["Lorgge", "medium"],
    ["Semiautonomous Kingdom of Zanasa", "small"],
    ["Mkala'al", "medium"],
    ["Coros", "medium"],
    ["Brelg", "medium"],
    ["Sar-sal-Salír", "medium"],
    ["Longmarsh", "medium"],
    ["Atrophykos", "medium"],
    ["Gilded-Lands", "medium"],
    ["Avaroth?", "medium"],
    ["Draid", "large"],
    ["Clayman Gildsman Lösman", "medium"],
    ["Sathal", "medium"],
    ["Anterros", "medium"],
    ["Thas-Thuay Collaborate", "medium"],
    ["Yadanai", "medium"],
    ["Lakyrimati", "large"],
    ["Sulphurfort", "medium"],
    ["Ilkair", "large"],
    ["Deilān Federation", "large"],
    ["Northern Shab Council", "medium"],
    ["Central Mint", "medium"],
    ["Operational No-Zones", "small"],
    ["Vladisland", "medium"],
    ["Jadiz", "medium"],
    ["Ithûk", "medium"],
    ["Dreadpoint", "medium"],
    ...
    ["Manastazs", "medium"],
    ["Calmarriné", "medium"],
    ["The Sixfold Star", "medium"],
    ["Isles of Security", "medium"],
    ["Mes-Mas-Malas", "medium"],
    ["Brassworks Fellowship", "small"],
    ["Moristene", "medium"],
    ["Northsea Confederacy", "large"],
    ["Hei Kophkatos", "medium"],
    ["Wahlrect", "medium"],
    ["Vaxassa Xaoxavas", "large"],
    ["Ilvor-Ilvindal", "medium"],
    ["Northern Jawbone", "large"],
    ["Bandlow", "medium"],
    ["Councilholds", "medium"],
    ["Wyndish Union", "large"],
    ["Southern Shab Council", "small"],
    ["Drairin", "large"],
    ["Britchoff", "large"],
    ["Crux", "large"],
    ["Glassblood", "large"]
...
export const territoryIcons = new Map([
    ["The Frontier", frontierIcon],
    ["Unbound Deepwood", deepwoodIcon],
    ["Wingblight Wastes", wingIcon],
    ["Dragonlaw", dragonIcon],
    ["Astral Scorch", astralIcon],
    ["Tannsland", tannIcon],
    ["Mountaincarver Tectonics", mountainIcon],
